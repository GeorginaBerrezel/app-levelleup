...
// Composant de la liste empilée (stacked list)
        ...
        <ul className="divide-y divide-gray-200">
            {people.map((person) => (
                <li key={person.email} className="py-4 flex">
                    ...
                    {/* Ajout d'une icône chevron (optionnel) */}
                    <ChevronRightIcon className="h-5 w-5 text-gray-400 ml-auto" aria-hidden="true" />
                </li>
            ))}
        </ul>
    );
